...
from tools.buffer import ReplayBuffer_List, RolloutBuffer_vanilla, ReplayBuffer_Graph, RolloutBuffer
...
class RL_Policy(object):
    def __init__(self, args):
        ...
        if not hasattr(args, 'graph_task'):
            ...
            self.state_dim = args.state_dim if not args.sac_mlp_enc else args.obs_shape["state"][0]
            ...
            self.buffer = ReplayBuffer_List(args.buffer_size, self.state_dim, args.action_dim, args.action_type)
        else:
