...
class GATEnhanceEncoder(torch.nn.Module):
    ...
    """
    def __init__(self, input_dim, edge_dim, output_dim, embedding_dim, n_head=2, n_layer=2, n_layer_with_edge_attr=1):
...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, embedding_dim, n_head):
        ...
        self.mlp = nn.Sequential(nn.Linear(embedding_dim, 128), 
